                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="container-fluid" style="color:white;">
                            ...
                            <form class="text-left" action="{{ url('tu/aksi_tambah_dosen') }}" method="post">
                                @csrf
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">NID</label>
                                    <div class="col-sm-10">
                                      <input type="text" name="nid" class="form-control" id="inputNama" placeholder="Masukan NID" style="border-color:white;">
                                    </div>
                                </div>
                                <div class="form-group row">
